...
// ----------
export const ItemCardBase = 'w-full flex flex-col items-start rounded border border-gray-300 cursor-pointer';
export const ItemCardImage =
  'flex justify-center items-center w-full rounded overflow-hidden';
export const ItemCardContent = 'flex flex-col items-start mt-3 p-2';
